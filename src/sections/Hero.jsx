import { curve, file02, heroBackground, homeSmile, loading, plusSquare, searchMd, yourlogo, appLogo } from "../assets";
            ...
            <div className="container relative" ref={parallaxRef}>
                <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
                    <h1 className="h1 mb-6">
                        Build AI that ships and delivers outcomes
                        <span className="inline-block relative">
                            Faster <img src={curve} className="absolute top-full left-0 w-full xl:-mt-2" width={624} height={28} alt="" />
                        </span>
                    </h1>
                    <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">We design and build custom AI tools that streamline operations, improve customer experience, and unlock growth — from discovery to deployment and beyond.</p>
                        ...
                        <div className="relative bg-n-8 rounded-[1rem]">
                            ...
                            <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                                <div className="relative w-full h-full">
                                    <div className="absolute inset-0 bg-radial-gradient from-[#5B47E0]/40 to-transparent to-70%" />
                                    <div className="absolute inset-0 opacity-40 bg-conic-gradient" />
                                    <div className="relative flex items-center justify-center w-full h-full">
                                        <div className="w-[5.5rem] aspect-square p-0.5 bg-conic-gradient rounded-xl">
                                            <div className="flex items-center justify-center w-full h-full bg-n-8 rounded-lg">
                                                <img src={appLogo} width={48} height={48} alt="Brand logo" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
